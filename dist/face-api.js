(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function convLayer(x, params, padding, withRelu) {
        ...
        return Oe(function () {
            var out = Ku(tu(x, params.filters, [1, 1], padding), params.bias);
            return withRelu ? Rl(out) : out;
        });
    }
    ...
    function extractConvParamsFactory(extractWeights, paramMappings) {
        return function (channelsIn, channelsOut, filterSize, mappedPrefix) {
            var filters = zn(extractWeights(channelsIn * channelsOut * filterSize * filterSize), [filterSize, filterSize, channelsIn, channelsOut]);
            var bias = Ln(extractWeights(channelsOut));
    ...
    function extractFCParamsFactory(extractWeights, paramMappings) {
        return function (channelsIn, channelsOut, mappedPrefix) {
            var fc_weights = Wn(extractWeights(channelsIn * channelsOut), [channelsIn, channelsOut]);
            var fc_bias = Ln(extractWeights(channelsOut));
    ...
    function extractSeparableConvParamsFactory(extractWeights, paramMappings) {
        return function (channelsIn, channelsOut, mappedPrefix) {
            var depthwise_filter = zn(extractWeights(3 * 3 * channelsIn), [3, 3, channelsIn, 1]);
            var pointwise_filter = zn(extractWeights(channelsIn * channelsOut), [1, 1, channelsIn, channelsOut]);
            var bias = Ln(extractWeights(channelsOut));
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        imgTensor3D = Oe(function () { return imgTensor.as3D(height, width, numChannels).toInt(); });
                        return [4 /*yield*/, Ih.toPixels(imgTensor3D, targetCanvas)];
                    case 1:
                        _b.sent();
                        imgTensor3D.dispose();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        manifest = _b.sent();
                        return [2 /*return*/, bh.loadWeights(manifest, modelBaseUri)];
                }
            });
        });
    }
    ...
    function padToSquare(imgTensor, isCenterImage) {
        ...
        return Oe(function () {
            ...
            return Rr(tensorsToStack, paddingAxis);
        });
    }
                ...
                var inputTensors = range(_this.batchSize, 0, 1).map(function (batchIdx) {
                    ...
                    if (input instanceof ht) {
                        ...
                        if (imgTensor.shape[1] !== inputSize || imgTensor.shape[2] !== inputSize) {
                            imgTensor = xc.resizeBilinear(imgTensor, [inputSize, inputSize]);
                        }
                        return imgTensor.as3D(inputSize, inputSize, 3);
                    }
                    if (input instanceof env.getEnv().Canvas) {
                        return Ih.fromPixels(imageToSquare(input, inputSize, isCenterInputs));
                    }
                    throw new Error("toBatchTensor - at batchIdx " + batchIdx + ", expected input to be instanceof tf.Tensor or instanceof HTMLCanvasElement, instead have " + input);
                });
                var batchTensor = lo(inputTensors.map(function (t) { return t.toFloat(); })).as4D(_this.batchSize, inputSize, inputSize, 3);
                return batchTensor;
            });
        };
        return NetInput;
                ...
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            ...
                            loadWeights = bh.weightsLoaderFactory(fetchWeightsFromDisk);
                            _c = (_b = JSON).parse;
    ...
    function normalize(x, meanRgb) {
        return Oe(function () {
            ...
            var avg_r = $n(x.shape.slice(0, 3).concat([1]), r);
            var avg_g = $n(x.shape.slice(0, 3).concat([1]), g);
            var avg_b = $n(x.shape.slice(0, 3).concat([1]), b);
            var avg_rgb = Rr([avg_r, avg_g, avg_b], 3);
            return fl(x, avg_rgb);
        });
    }
    ...
    function leaky(x) {
        return Oe(function () {
            var min = sl(x, Pn(0.10000000149011612));
            return Ku(Rl(fl(x, min)), min);
    ...
    function convWithBatchNorm(x, params) {
        return Oe(function () {
            var out = Jr(x, [[0, 0], [1, 1], [1, 1], [0, 0]]);
            out = tu(out, params.conv.filters, [1, 1], 'valid');
            out = fl(out, params.bn.sub);
            out = sl(out, params.bn.truediv);
            out = Ku(out, params.conv.bias);
            return leaky(out);
        });
    }
    ...
    function depthwiseSeparableConv(x, params) {
        return Oe(function () {
            var out = Jr(x, [[0, 0], [1, 1], [1, 1], [0, 0]]);
            out = ou(out, params.depthwise_filter, params.pointwise_filter, [1, 1], 'valid');
            out = Ku(out, params.bias);
            return leaky(out);
        });
    }
    ...
    function extractorsFactory(extractWeights, paramMappings) {
        ...
        function extractBatchNormParams(size, mappedPrefix) {
            var sub = Ln(extractWeights(size));
            var truediv = Ln(extractWeights(size));
        ...
        TinyYolov2.prototype.forwardInput = function (input, inputSize) {
            ...
            return Oe(function () {
                ...
                batchTensor = _this.config.meanRgb
                    ...
                    : batchTensor;
                batchTensor = batchTensor.div(Pn(256));
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            out = _b.sent();
                            out0 = Oe(function () { return po(out)[0].expandDims(); });
                            inputDimensions = {
                        ...
                        case 0:
                            ...
                            _a = Oe(function () {
                                ...
                                var classScores = _this.withClassScores
                                    ? Dn(reshaped.slice([0, 0, 0, 5], [numCells, numCells, numBoxes, _this.config.classes.length]), 3)
                                    : Pn(0);
    ...
    function depthwiseSeparableConv$1(x, params, stride) {
        return Oe(function () {
            var out = ou(x, params.depthwise_filter, params.pointwise_filter, stride, 'same');
            out = Ku(out, params.bias);
            return out;
        });
    }
    ...
    function denseBlock4(x, denseBlockParams, isFirstLayer, isScaleDown) {
        ...
        return Oe(function () {
            var out1 = Rl(isFirstLayer
                ? Ku(tu(x, denseBlockParams.conv0.filters, isScaleDown ? [2, 2] : [1, 1], 'same'), denseBlockParams.conv0.bias)
                : depthwiseSeparableConv$1(x, denseBlockParams.conv0, isScaleDown ? [2, 2] : [1, 1]));
            var out2 = depthwiseSeparableConv$1(out1, denseBlockParams.conv1, [1, 1]);
            var in3 = Rl(Ku(out1, out2));
            var out3 = depthwiseSeparableConv$1(in3, denseBlockParams.conv2, [1, 1]);
            var in4 = Rl(Ku(out1, Ku(out2, out3)));
            var out4 = depthwiseSeparableConv$1(in4, denseBlockParams.conv3, [1, 1]);
            return Rl(Ku(out1, Ku(out2, Ku(out3, out4))));
        });
    }
    ...
    var FaceFeatureExtractor = /** @class */ (function (_super) {
        ...
        FaceFeatureExtractor.prototype.forwardInput = function (input) {
            ...
            return Oe(function () {
                ...
                var normalized = normalize(batchTensor, meanRgb).div(Pn(255));
                var out = denseBlock4(normalized, params.dense0, true);
                out = denseBlock4(out, params.dense1);
                out = denseBlock4(out, params.dense2);
                out = denseBlock4(out, params.dense3);
                out = gu(out, [7, 7], [2, 2], 'valid');
                return out;
            });
        };
    ...
    function fullyConnectedLayer(x, params) {
        return Oe(function () {
            return Ku(iu(x, params.weights), params.bias);
        });
    }
    ...
    var FaceExpressionNet = /** @class */ (function (_super) {
        ...
        FaceExpressionNet.prototype.forwardInput = function (input) {
            var _this = this;
            return Oe(function () { return Dn(_this.runNet(input)); });
        };
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            out = _a.sent();
                            return [4 /*yield*/, Promise.all(po(out).map(function (t) { return __awaiter(_this, void 0, void 0, function () {
                                    var data;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
    ...
    function conv(x, params, stride) {
        return Ku(tu(x, params.filters, stride, 'same'), params.bias);
    }
    function reductionBlock(x, params, isActivateInput) {
        if (isActivateInput === void 0) { isActivateInput = true; }
        var out = isActivateInput ? Rl(x) : x;
        out = depthwiseSeparableConv$1(out, params.separable_conv0, [1, 1]);
        out = depthwiseSeparableConv$1(Rl(out), params.separable_conv1, [1, 1]);
        out = mu(out, [3, 3], [2, 2], 'same');
        out = Ku(out, conv(x, params.expansion_conv, [2, 2]));
        return out;
    }
    function mainBlock(x, params) {
        var out = depthwiseSeparableConv$1(Rl(x), params.separable_conv0, [1, 1]);
        out = depthwiseSeparableConv$1(Rl(out), params.separable_conv1, [1, 1]);
        out = depthwiseSeparableConv$1(Rl(out), params.separable_conv2, [1, 1]);
        out = Ku(out, x);
        return out;
    }
    var TinyXception = /** @class */ (function (_super) {
        ...
        TinyXception.prototype.forwardInput = function (input) {
            ...
            return Oe(function () {
                var batchTensor = input.toBatchTensor(112, true);
                var meanRgb = [122.782, 117.001, 104.298];
                var normalized = normalize(batchTensor, meanRgb).div(Pn(256));
                var out = Rl(conv(normalized, params.entry_flow.conv_in, [2, 2]));
                ...
                out = Rl(depthwiseSeparableConv$1(out, params.exit_flow.separable_conv, [1, 1]));
                return out;
            });
        };
    ...
    var AgeGenderNet = /** @class */ (function (_super) {
        ...
        AgeGenderNet.prototype.runNet = function (input) {
            ...
            return Oe(function () {
                var bottleneckFeatures = input instanceof NetInput
                    ? _this.faceFeatureExtractor.forwardInput(input)
                    : input;
                var pooled = gu(bottleneckFeatures, [7, 7], [2, 2], 'valid').as2D(bottleneckFeatures.shape[0], -1);
        ...
        AgeGenderNet.prototype.forwardInput = function (input) {
            ...
            return Oe(function () {
                ...
                return { age: age, gender: Dn(gender) };
            });
        };
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, Oe(function () {
                        ...
                        var faceTensors = boxes.map(function (_a) {
                            var x = _a.x, y = _a.y, width = _a.width, height = _a.height;
                            return Cu(imageTensor.as3D(imgHeight, imgWidth, numChannels), [y, x, 0], [height, width, numChannels]);
                        });
                        return faceTensors;
                    })];
            });
        ...
        FaceLandmark68NetBase.prototype.postProcess = function (output, inputSize, originalDimensions) {
            ...
            return Oe(function () {
                ...
                var landmarkTensors = output
                    .mul($n([batchSize, 136], inputSize))
                    .sub(lo(Array.from(Array(batchSize), function (_, batchIdx) {
                    return createInterleavedTensor(getPaddingX(batchIdx), getPaddingY(batchIdx));
                })))
                    .div(lo(Array.from(Array(batchSize), function (_, batchIdx) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            netInput = _a.sent();
                            landmarkTensors = Oe(function () { return po(_this.forwardInput(netInput)); });
    ...
    function extractorsFactory$4(extractWeights, paramMappings) {
        function extractFilterValues(numFilterValues, numFilters, filterSize) {
            ...
            return Oe(function () { return Sl(zn(weights, [numFilters, depth, filterSize, filterSize]), [2, 3, 1, 0]); });
        }
        function extractConvParams(numFilterValues, numFilters, filterSize, mappedPrefix) {
            var filters = extractFilterValues(numFilterValues, numFilters, filterSize);
            var bias = Ln(extractWeights(numFilters));
            paramMappings.push({ paramPath: mappedPrefix + "/filters" }, { paramPath: mappedPrefix + "/bias" });
            return { filters: filters, bias: bias };
        }
        function extractScaleLayerParams(numWeights, mappedPrefix) {
            var weights = Ln(extractWeights(numWeights));
            var biases = Ln(extractWeights(numWeights));
    ...
    function extractParams$5(weights) {
        ...
        var fc = Oe(function () { return Sl(Wn(extractWeights(256 * 128), [128, 256]), [1, 0]); });
    ...
    function residualDown(x, params) {
        ...
        out = convNoRelu(out, params.conv2);
        var pooled = gu(x, 2, 2, 'valid');
        var zeros = Hn(pooled.shape);
        var isPad = pooled.shape[3] !== out.shape[3];
        var isAdjustShape = pooled.shape[1] !== out.shape[1] || pooled.shape[2] !== out.shape[2];
        if (isAdjustShape) {
            var padShapeX = out.shape.slice();
            padShapeX[1] = 1;
            var zerosW = Hn(padShapeX);
            out = Rr([out, zerosW], 1);
            var padShapeY = out.shape.slice();
            padShapeY[2] = 1;
            var zerosH = Hn(padShapeY);
            out = Rr([out, zerosH], 2);
        }
        pooled = isPad ? Rr([pooled, zeros], 3) : pooled;
        out = Ku(pooled, out);
        out = Rl(out);
        return out;
    }
    ...
    var FaceRecognitionNet = /** @class */ (function (_super) {
        ...
        FaceRecognitionNet.prototype.forwardInput = function (input) {
            ...
            return Oe(function () {
                ...
                var fullyConnected = iu(globalAvg, params.fc);
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            netInput = _a.sent();
                            faceDescriptorTensors = Oe(function () { return po(_this.forwardInput(netInput)); });
    ...
    function extractorsFactory$6(extractWeights, paramMappings) {
        function extractDepthwiseConvParams(numChannels, mappedPrefix) {
            var filters = zn(extractWeights(3 * 3 * numChannels), [3, 3, numChannels, 1]);
            var batch_norm_scale = Ln(extractWeights(numChannels));
            var batch_norm_offset = Ln(extractWeights(numChannels));
            var batch_norm_mean = Ln(extractWeights(numChannels));
            var batch_norm_variance = Ln(extractWeights(numChannels));
    ...
    function extractParams$6(weights) {
        ...
        var extra_dim = Un(extractWeights(5118 * 4), [1, 5118, 4]);
        var output_layer = {
            extra_dim: extra_dim
        };
    ...
    function pointwiseConvLayer(x, params, strides) {
        return Oe(function () {
            var out = tu(x, params.filters, strides, 'same');
            out = Ku(out, params.batch_norm_offset);
            return ls(out, 0, 6);
        });
    }
    ...
    function depthwiseConvLayer(x, params, strides) {
        return Oe(function () {
            var out = ru(x, params.filters, strides, 'same');
            out = $s(out, params.batch_norm_mean, params.batch_norm_variance, params.batch_norm_offset, params.batch_norm_scale, epsilon);
            return ls(out, 0, 6);
        });
    }
    ...
    function getCenterCoordinatesAndSizesLayer(x) {
        ...
        var centers = [
            Ku(vec[0], Ju(sizes[0], Pn(2))),
            Ku(vec[1], Ju(sizes[1], Pn(2)))
        ];
        return {
            sizes: sizes,
            centers: centers
    ...
    function decodeBoxesLayer(x0, x1) {
        ...
        var vec = po(Sl(x1, [1, 0]));
        var div0_out = Ju(sl(fs(Ju(vec[2], Pn(5))), sizes[0]), Pn(2));
        var add0_out = Ku(sl(Ju(vec[0], Pn(10)), sizes[0]), centers[0]);
        var div1_out = Ju(sl(fs(Ju(vec[3], Pn(5))), sizes[1]), Pn(2));
        var add1_out = Ku(sl(Ju(vec[1], Pn(10)), sizes[1]), centers[1]);
        return Sl(lo([
            fl(add0_out, div0_out),
            fl(add1_out, div1_out),
            Ku(add0_out, div0_out),
            Ku(add1_out, div1_out)
        ]), [1, 0]);
    }
    function outputLayer(boxPredictions, classPredictions, params) {
        return Oe(function () {
            var batchSize = boxPredictions.shape[0];
            var boxes = decodeBoxesLayer(io(co(params.extra_dim, [batchSize, 1, 1]), [-1, 4]), io(boxPredictions, [-1, 4]));
            boxes = io(boxes, [batchSize, (boxes.shape[0] / batchSize), 4]);
            var scoresAndClasses = Es(xu(classPredictions, [0, 0, 1], [-1, -1, -1]));
            var scores = xu(scoresAndClasses, [0, 0, 0], [-1, -1, 1]);
            scores = io(scores, [batchSize, scores.shape[1]]);
            var boxesByBatch = po(boxes);
            var scoresByBatch = po(scores);
            return {
                boxes: boxesByBatch,
    ...
    function boxPredictionLayer(x, params) {
        return Oe(function () {
            ...
            var boxPredictionEncoding = io(convLayer(x, params.box_encoding_predictor), [batchSize, -1, 1, 4]);
            var classPrediction = io(convLayer(x, params.class_predictor), [batchSize, -1, 3]);
            return {
    ...
    var SsdMobilenetv1 = /** @class */ (function (_super) {
        ...
        SsdMobilenetv1.prototype.forwardInput = function (input) {
            ...
            return Oe(function () {
                ...
                var x = fl(sl(batchTensor, Pn(0.007843137718737125)), Pn(1));
    ...
    function bgrToRgbTensor(tensor) {
        return Oe(function () { return lo(po(tensor, 3).reverse(), 3); });
    }
    ...
    function extractorsFactory$8(extractWeights, paramMappings) {
        ...
        function extractPReluParams(size, paramPath) {
            var alpha = Ln(extractWeights(size));
    ...
    function normalize$1(x) {
        return Oe(function () { return sl(fl(x, Pn(127.5)), Pn(0.0078125)); });
    }

    function prelu(x, alpha) {
        return Oe(function () {
            return Ku(Rl(x), sl(alpha, xs(Rl(xs(x)))));
        });
    }
    ...
    function sharedLayer(x, params, isPnet) {
        ...
        return Oe(function () {
            ...
            out = mu(out, isPnet ? [2, 2] : [3, 3], [2, 2], 'same');
            out = convLayer(out, params.conv2, 'valid');
            out = prelu(out, params.prelu2_alpha);
            out = isPnet ? out : mu(out, [3, 3], [2, 2], 'valid');
    ...
    function PNet(x, params) {
        return Oe(function () {
            ...
            var max = Kr(Tu(conv, 3), 3);
            var prob = Dn(fl(conv, max), 3);
    ...
    function rescaleAndNormalize(x, scale) {
        return Oe(function () {
            ...
            var resized = xc.resizeBilinear(x, [height, width]);
            var normalized = normalize$1(resized);
            return Sl(normalized, [0, 2, 1, 3]);
        });
    }
    ...
    function stage1(imgTensor, scales, scoreThreshold, params, stats) {
        stats.stage1 = [];
        var pnetOutputs = scales.map(function (scale) { return Oe(function () {
            ...
            var scoresTensor = po(po(prob, 3)[1])[0];
            var regionsTensor = po(regions)[0];
            return {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, imagePatchesDatas.map(function (data) {
                                var t = Oe(function () {
                                    var imagePatchTensor = Sl(zn(data, [1, width, height, 3]), [0, 2, 1, 3]).toFloat();
    ...
    function RNet(x, params) {
        return Oe(function () {
            ...
            var vectorized = io(convOut, [convOut.shape[0], params.fc1.weights.shape[0]]);
            ...
            var max = Kr(Tu(fc2_1, 1), 1);
            var prob = Dn(fl(fc2_1, max), 1);
            var regions = fullyConnectedLayer(prelu4, params.fc2_2);
            var scores = po(prob, 1)[1];
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        scoresTensor = rnetOuts.length > 1
                            ? Rr(rnetOuts.map(function (out) { return out.scores; }))
                            : rnetOuts[0].scores;
                        _b = (_a = Array).from;
    ...
    function ONet(x, params) {
        return Oe(function () {
            ...
            var vectorized = io(out, [out.shape[0], params.fc1.weights.shape[0]]);
            var fc1 = fullyConnectedLayer(vectorized, params.fc1);
                ...
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        scoresTensor = onetOuts.length > 1
                            ? Rr(onetOuts.map(function (out) { return out.scores; }))
                            : onetOuts[0].scores;
                        _b = (_a = Array).from;
                        return [4 /*yield*/, scoresTensor.data()];
                    case 2:
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            ...
                            stats = {};
                            tsTotal = Date.now();
                            imgTensor = Oe(function () {
                                return bgrToRgbTensor(Kr(Ih.fromPixels(inputCanvas)).toFloat());
                            });
